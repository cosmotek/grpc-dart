...
const FileDescriptorProto$json = const {
  ...
  '2': const [
    ...
    const {'1': 'edition', '3': 13, '4': 1, '5': 9, '10': 'edition'},
  ],
};

/// Descriptor for `FileDescriptorProto`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fileDescriptorProtoDescriptor = $convert.base64Decode('');
...
const FieldOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'unverified_lazy', '3': 15, '4': 1, '5': 8, '7': 'false', '10': 'unverifiedLazy'},
    const {'1': 'deprecated', '3': 3, '4': 1, '5': 8, '7': 'false', '10': 'deprecated'},
...
@$core.Deprecated('Use fieldOptionsDescriptor instead')
const FieldOptions_OptionRetention$json = const {
  '1': 'OptionRetention',
  '2': const [
    const {'1': 'RETENTION_UNKNOWN', '2': 0},
    const {'1': 'RETENTION_RUNTIME', '2': 1},
    const {'1': 'RETENTION_SOURCE', '2': 2},
  ],
};

@$core.Deprecated('Use fieldOptionsDescriptor instead')
const FieldOptions_OptionTargetType$json = const {
  '1': 'OptionTargetType',
  '2': const [
    const {'1': 'TARGET_TYPE_UNKNOWN', '2': 0},
    const {'1': 'TARGET_TYPE_FILE', '2': 1},
    const {'1': 'TARGET_TYPE_EXTENSION_RANGE', '2': 2},
    const {'1': 'TARGET_TYPE_MESSAGE', '2': 3},
    const {'1': 'TARGET_TYPE_FIELD', '2': 4},
    const {'1': 'TARGET_TYPE_ONEOF', '2': 5},
    const {'1': 'TARGET_TYPE_ENUM', '2': 6},
    const {'1': 'TARGET_TYPE_ENUM_ENTRY', '2': 7},
    const {'1': 'TARGET_TYPE_SERVICE', '2': 8},
    const {'1': 'TARGET_TYPE_METHOD', '2': 9},
  ],
};
...
const GeneratedCodeInfo_Annotation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'semantic', '3': 5, '4': 1, '5': 14, '6': '.google.protobuf.GeneratedCodeInfo.Annotation.Semantic', '10': 'semantic'},
  ],
  '4': const [GeneratedCodeInfo_Annotation_Semantic$json],
};

@$core.Deprecated('Use generatedCodeInfoDescriptor instead')
const GeneratedCodeInfo_Annotation_Semantic$json = const {
  '1': 'Semantic',
  '2': const [
    const {'1': 'NONE', '2': 0},
    const {'1': 'SET', '2': 1},
...
final $typed_data.Uint8List generatedCodeInfoDescriptor = $convert.base64Decode('');
