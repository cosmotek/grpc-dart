...
const ServerReflectionRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'file_containing_extension', '3': 5, '4': 1, '5': 11, '6': '.grpc.reflection.v1.ExtensionRequest', '9': 0, '10': 'fileContainingExtension'},
...
final $typed_data.Uint8List serverReflectionRequestDescriptor = $convert.base64Decode('');
...
const ServerReflectionResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'original_request', '3': 2, '4': 1, '5': 11, '6': '.grpc.reflection.v1.ServerReflectionRequest', '10': 'originalRequest'},
    const {'1': 'file_descriptor_response', '3': 4, '4': 1, '5': 11, '6': '.grpc.reflection.v1.FileDescriptorResponse', '9': 0, '10': 'fileDescriptorResponse'},
    const {'1': 'all_extension_numbers_response', '3': 5, '4': 1, '5': 11, '6': '.grpc.reflection.v1.ExtensionNumberResponse', '9': 0, '10': 'allExtensionNumbersResponse'},
    const {'1': 'list_services_response', '3': 6, '4': 1, '5': 11, '6': '.grpc.reflection.v1.ListServiceResponse', '9': 0, '10': 'listServicesResponse'},
    const {'1': 'error_response', '3': 7, '4': 1, '5': 11, '6': '.grpc.reflection.v1.ErrorResponse', '9': 0, '10': 'errorResponse'},
  ],
  '8': const [
...
final $typed_data.Uint8List serverReflectionResponseDescriptor = $convert.base64Decode('');
...
const ListServiceResponse$json = const {
  ...
  '2': const [
    const {'1': 'service', '3': 1, '4': 3, '5': 11, '6': '.grpc.reflection.v1.ServiceResponse', '10': 'service'},
  ],
};

/// Descriptor for `ListServiceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listServiceResponseDescriptor = $convert.base64Decode('ChNMaXN0U2VydmljZVJlc3BvbnNlEj0KB3NlcnZpY2UYASADKAsyIy5ncnBjLnJlZmxlY3Rpb24udjEuU2VydmljZVJlc3BvbnNlUgdzZXJ2aWNl');
