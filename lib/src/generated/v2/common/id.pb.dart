...
class IDInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IDInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'v2.common'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  IDInput copyWith(void Function(IDInput) updates) => super.copyWith((message) => updates(message as IDInput)) as IDInput; // ignore: deprecated_member_use
